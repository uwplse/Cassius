...
reports/fwt.html reports/fwt.json: bench/fwt.rkt
	...
	xvfb-run -a -s '-screen 0 1920x1080x24' python3 minimize.py --cache reports/fwt.cache reports/fwt.json
	racket src/report.rkt rerender --cache reports/fwt.cache --show-all --timeout 900 -o reports/fwt reports/fwt.json
