...
reports/vizassert.html reports/vizassert.json: bench/fwt/valid.txt $(shell cat bench/fwt/valid.txt)
	@ racket src/report.rkt assertions $(FLAGS) --expected bench/fwt/expected.sexp --aggregate --timeout 600 -o reports/vizassert assertions.vizassert `cat bench/fwt/valid.txt`
