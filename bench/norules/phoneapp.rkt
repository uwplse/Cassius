...
(define-document (mockup #:width 750)
  ((BLOCK :tag html :w 750 :x 0 :y 0 :style ())
   ((BLOCK :tag body :w 750 :h 1075 :x 0 :y 109.0
           :style ([padding (px 25) (px 25) (px 25) (px 25)] [position absolute] [width (% 100)] [top (px 109)] [bottom (px 150)]))
    ((BLOCK :tag div :style ())
...
(define-document (bigger #:width 1100)
  ((BLOCK :tag html :w 1100 :x 0 :y 0.0 :style ())
   ((BLOCK :tag body :w 1100 :h 1661 :x 0 :y 109.0
           :style ([padding ? ? ? ?] [position ?] [width ?] [top ?] [bottom ?]))
    ((BLOCK :tag div :style ())
...
(define-document (mockup-correct #:width 750)
  ((BLOCK :tag html :w 750 :x 0 :y 0 
          :style ())
   ((BLOCK :tag rect :w 750 :h 1075 :x 0 :y 109.0 
           :style ([padding (px 25) (px 25) (px 25) (px 25)] [position absolute] [width (% 100)] [top (px 109)] [bottom (px 150)]))
    ((BLOCK :tag g 
            :style ())
   ...
   ((BLOCK :tag g 
    ...
    ((BLOCK :tag rect :w 100 :h 100 :x 100 :y 1209.0 
            :style ([float left] [height (px 100)] [width (px 100)] [margin (px 50) (px 25) (px 50) (px 25)])))
    ((BLOCK :tag rect :w 100 :h 100 :x 250 :y 1209.0 
            :style ([float left] [height (px 100)] [width (px 100)] [margin (px 50) (px 25) (px 50) (px 25)])))
    ((BLOCK :tag rect :w 100 :h 100 :x 400 :y 1209.0 
            :style ([float left] [height (px 100)] [width (px 100)] [margin (px 50) (px 25) (px 50) (px 25)])))
