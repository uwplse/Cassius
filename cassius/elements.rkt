...
(provide element-general-constraints
         box-block-constraints box-inline-constraints box-line-constraints box-float-constraints
         element-definitions)
  ...
  `((define-fun an-element ((e Element)) Bool
    ...
    (define-fun a-line-box ((b Box)) Bool
      ,(smt-let ([e (get/elt (element b))] [p (pbox b)] [v (vbox b)] [vff (vffbox b)]
                ...
                (ite (and
                      (> (- (right-outer l) (left-outer f)) (- (right-content p) (right-outer vff)))
    ...
    (define-fun a-block-float-box ((b Box)) Bool
      ,(smt-let ([e (get/elt (element b))] [r (rules (get/elt (element b)))]
                ...
                ; TODO: Currently impossible so unimplemented
                ...
                ; generated by an element earlier in the source document.
                ; SIMPL: Combined to, may not be higher than the top of the previous float or flow box
                (=> (is-box vff) (>= (top-outer b) (top-outer vff)))
                (=> (is-box vff) (>= (top-outer b) (top-outer vb)))
                ...
                (or (= (top-outer b) (ite (is-no-box vb) (top-content p) (bottom-border (vbox b))))
