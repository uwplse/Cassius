...
(define (general-float-constraints e)
  ...
  (asserts
   ...
   (or (is-no-box ,bff)
       (= (left-outer ,b) (right-outer ,bff))
       (>= (box-top ,b) (right-outer ,bff)))
   ...
   (=> (is-box ,bff) (>= (top-outer ,b) (top-outer ,bff)))
   (=> (is-box ,bff) (>= (top-outer ,b) (top-outer ,bnf)))
   ...
   ; TODO: An analogous rule holds for right-floating elements.
   (=> (and (is-box ,bff) (< (x ,bff) (x ,b)) (horizontally-adjacent ,b ,bff))
